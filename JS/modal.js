   (() => {
    const refs = {
      ...
      modal: document.querySelector("[data-modal-hodowa]"),
    };
  ...
  (() => {
    const refs = {
      openModalBtn: document.querySelector("[data-modal-open-hamulce]"),
      closeModalBtn: document.querySelector("[data-modal-close-hamulce]"),
      modal: document.querySelector("[data-modal-hamulce]"),
    };
  ...
  (() => {
    const refs = {
      openModalBtn: document.querySelector("[data-modal-open-przenoszenie]"),
      closeModalBtn: document.querySelector("[data-modal-close-przenoszenie]"),
      modal: document.querySelector("[data-modal-przenoszenie]"),
    };
